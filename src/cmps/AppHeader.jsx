            ...
            <header className="app-header">
                <nav>
                    ...
                    <ul className="nav-icons flex">
                        <li className="bell-icon grid-center">
                            <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentFill">
                        ...
                        <li className="msg-icon grid-center">
                            <svg width="20" height="20" viewBox="0 0 18 16" xmlns="http://www.w3.org/2000/svg" fill="currentFill">
                        ...
                        <li className="heart-icon grid-center">
